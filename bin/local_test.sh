...
$REDGOLD_BINARY_PATH --network local --debug-id 10 --genesis --disable-e2e node >log0 2>&1 &
export NODE_1_PID=$!

sleep 7

$REDGOLD_BINARY_PATH --network local --debug-id 11 --seed-address 127.0.0.1 --seed-port-offset 26880 --disable-e2e node >log1 2>&1 &
export NODE_2_PID=$!

sleep 7

$REDGOLD_BINARY_PATH --network local --debug-id 12 --seed-address 127.0.0.1 --seed-port-offset 26880 --disable-e2e node >log2 2>&1 &
export NODE_3_PID=$!
