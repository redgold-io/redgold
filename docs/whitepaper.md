...
Attempts to solve this through sharding or partitioning or otherwise which still compound up to a global state 
...
Treasury smoothing function with usd equivalents. Sell spikes and buy troughs

## Issues with Proof of Stake

//todo: where should this section actually go? Should I break up the intro more?
...
Small PoW networks get hacked easily <- move to pow section.
...
The fundamental architecture is literally only dependencies. 
