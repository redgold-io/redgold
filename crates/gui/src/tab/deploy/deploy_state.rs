...
pub struct ServersState {
    ...
    pub generate_offline_words: String,
    pub generate_offline_pass: String,
    pub generate_offline_offset: String,
...
impl Default for ServersState {
    fn default() -> Self {
        Self {
            ...
            generate_offline_words: "".to_string(),
            generate_offline_pass: "".to_string(),
            generate_offline_offset: "".to_string(),
